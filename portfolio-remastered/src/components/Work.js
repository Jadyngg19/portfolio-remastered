            ...
            <div className="project-card">
                ...
                <div className="proj-details">
                    ...
                    <div className="proj-buttons">
                        <NavLink to="https://photos.app.goo.gl/JyFSGB6EPSSf5iFi8" className="button">View</NavLink>
                        <NavLink to="https://github.com/Jadyngg19/Technically-Social-API" className="button">Source</NavLink>
                    </div>
                </div>
            </div>
        </div>
